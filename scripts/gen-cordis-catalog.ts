...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  documentArtifacts: 'document-artifacts.md',
  imageGeneration: 'image-generation.md',
  ...
  userCredentials: 'credentials.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  AuthPrincipal: 'authentication.md',
  AuthUser: 'authentication.md',
  CreateLocalUserInput: 'authentication.md',
  DesktopDevice: 'authentication.md',
  DesktopDeviceId: 'authentication.md',
  IssuedAuthSession: 'authentication.md',
  OidcClientConfig: 'authentication.md',
  OidcLoginInput: 'authentication.md',
  RegisterDesktopDeviceInput: 'authentication.md',
  SharedDeepSeekPreference: 'authentication.md',
  TypertGatewayMiddleware: 'typert.md',
  UpdateUserInput: 'authentication.md',
  UserId: 'authentication.md',
  UserPaths: 'authentication.md',
  Agent: 'core.md',
  ...
  ImageAspectRatio: 'image-generation.md',
  ImageGenerationBase: 'image-generation.md',
  ImageGenerationCollectRequest: 'image-generation.md',
  ImageGenerationCompleted: 'image-generation.md',
  ImageGenerationPending: 'image-generation.md',
  ImageGenerationRequest: 'image-generation.md',
  ImageGenerationResult: 'image-generation.md',
  ...
  DocumentArtifactResult: 'document-artifacts.md',
  PresentationRequest: 'document-artifacts.md',
  PresentationSlide: 'document-artifacts.md',
  SpreadsheetFormula: 'document-artifacts.md',
  SpreadsheetNumberFormat: 'document-artifacts.md',
  SpreadsheetRequest: 'document-artifacts.md',
  SpreadsheetSheet: 'document-artifacts.md',
  WordDocumentRequest: 'document-artifacts.md',
  WordSection: 'document-artifacts.md',
  WordTable: 'document-artifacts.md',
  ...
  UserCredentialScope: 'credentials.md',
