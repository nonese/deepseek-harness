...
const PATTERNS = [
  ...
  'packages/*/*.md',
  'packages/*/*/*.md',
  // Snapshot cases have the fixed snapshots/<surface>/<case> layout. Avoid a
  // Node 25 glob bug that descends through a file symlink when `**` precedes
  // the same literal filename.
