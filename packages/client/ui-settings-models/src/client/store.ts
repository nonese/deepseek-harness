...
export interface ProviderDirectoryEntry {
  ...
  /** Models whose credential is supplied by deployment policy for this browser session. */
  readonly managedModels?: readonly string[]
}
...
export function joinProviderDirectory(
  ...
  const rows: ProviderDirectoryEntry[] = directory.map(entry => ({
    ...
    ...entry.managedModels === undefined ? {} : { managedModels: [...entry.managedModels] },
  }))
