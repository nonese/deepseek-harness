...
export const en = {
  nav: 'Models',
  serverNav: 'Model sources',
  serverTitle: 'Model sources',
  serverIntro: 'The session model selector combines the models already available to you with administrator-managed models that you enable here.',
  serverSelectionTitle: 'Switch the current session model',
  serverSelectionHint: 'Close Settings, then select the model name beside the message box. The selection applies only to the current session.',
  serverLoading: 'Loading model sources…',
  serverLoadFailed: 'Loading model sources failed',
  serverInvalidResponse: 'The server returned an invalid model-source response.',
  serverRequestStatus: 'The server returned status {status}.',
  serverPersonalTitle: 'Personal DeepSeek API key',
  serverPersonalDescription: 'Used only by your own official DeepSeek model requests and DeepSeek web searches. The value is write-only and isolated from other users.',
  serverPersonalSave: 'Save personal key',
  serverPersonalSaving: 'Saving…',
  serverPersonalSaved: 'Your personal DeepSeek API key was saved.',
  serverPersonalRemove: 'Remove personal key',
  serverPersonalRemoved: 'Your personal DeepSeek API key was removed.',
  serverPersonalUnavailable: 'Personal credential storage is unavailable for this account.',
  serverAvailableSites: 'Administrator-managed model sites',
  serverConfigured: 'Available',
  serverNotConfigured: 'Not configured',
  serverNoModels: 'No models published',
  serverUseManaged: 'Use administrator-managed models',
  serverEnabledHelp: 'Managed models appear in the session model selector.',
  serverDisabledHelp: 'Only the other models available to your account appear in the selector.',
  serverEnabledNotice: 'Administrator-managed models are enabled. Reopen the session model selector to refresh its list.',
  serverDisabledNotice: 'Administrator-managed models are disabled for your sessions.',
  title: 'Models',
  ...
  welcomeBody: "Harness 0.1 remains in testing for Harness developers. Many areas need further improvement, and we welcome feedback from the developer community. Harness's core plugins and foundational APIs will continue to evolve rapidly over the coming months.\n\nWe look forward to exploring the limits of intelligence with developers around the world, building on open-source, open, reusable, and composable infrastructure. We welcome Harness developers everywhere to join the plugin ecosystem.",
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  serverNav: '模型来源',
  serverTitle: '模型来源',
  serverIntro: '会话模型选择器会合并你当前可用的模型，以及你在此启用的管理员统一模型。',
  serverSelectionTitle: '切换当前会话模型',
  serverSelectionHint: '关闭设置后，点击消息输入框旁的模型名称进行选择；该选择只作用于当前会话。',
  serverLoading: '正在加载模型来源…',
  serverLoadFailed: '加载模型来源失败',
  serverInvalidResponse: '服务器返回了无效的模型来源数据。',
  serverRequestStatus: '服务器返回状态码 {status}。',
  serverPersonalTitle: '个人 DeepSeek API Key',
  serverPersonalDescription: '仅用于你自己的 DeepSeek 官方模型请求和 DeepSeek 网页搜索；密钥只写入且与其他用户隔离。',
  serverPersonalSave: '保存个人密钥',
  serverPersonalSaving: '保存中…',
  serverPersonalSaved: '个人 DeepSeek API Key 已保存。',
  serverPersonalRemove: '删除个人密钥',
  serverPersonalRemoved: '个人 DeepSeek API Key 已删除。',
  serverPersonalUnavailable: '当前账号无法使用个人凭据存储。',
  serverAvailableSites: '管理员统一模型站点',
  serverConfigured: '可用',
  serverNotConfigured: '未配置',
  serverNoModels: '未发布模型',
  serverUseManaged: '使用管理员统一模型',
  serverEnabledHelp: '统一模型会出现在会话模型选择器中。',
  serverDisabledHelp: '选择器只显示当前账号的其他可用模型。',
  serverEnabledNotice: '已启用管理员统一模型；重新打开会话模型选择器即可刷新列表。',
  serverDisabledNotice: '已对你的会话停用管理员统一模型。',
  title: '模型',
  ...
  creating: '创建中\u2026',
  welcomeTitle: '内测声明',
  welcomeBody: 'Harness 目前的 0.1 版本仍处在面向 Harness 开发者进行测试的阶段，还有许多地方需要持续改进和打磨，希望听取广大开发者的反馈建议。预计 Harness 的核心插件以及基础 API 都会在接下来的一段时间内快速迭代、持续演化。\n\n我们期待与全球开发者一起，在开源、开放、可复用、可组合的基础设施之上，共同探索智能上限。欢迎全球 Harness 开发者加入插件生态。',
  welcomeContinue: '继续',
