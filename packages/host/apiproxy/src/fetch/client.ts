...
/**
 * Mint an RFC 4122 version 4 UUID on plain-HTTP LAN origins. Browsers expose
 * `crypto.getRandomValues()` there, while `crypto.randomUUID()` is restricted
 * to secure contexts.
 * @returns a browser-safe random UUID.
 */
