...
来源：[`packages/identity/auth-file/src/index.ts:89`](../packages/identity/auth-file/src/index.ts)
...
来源：[`packages/image/image-generation-dreamina/src/index.ts:24`](../packages/image/image-generation-dreamina/src/index.ts)
...
来源：[`packages/sandbox/sandbox-policy/src/index.ts:119`](../packages/sandbox/sandbox-policy/src/index.ts)
...
- `@deepseek-ai/dsh-skill-product-design` — 需要 `skills`（[`packages/skill/skill-product-design/src/index.ts`](../packages/skill/skill-product-design/src/index.ts)）
...
- `@deepseek-ai/dsh-tool-image-generation` — 需要 `attachments` · `imageGeneration` · `llm` · `tools`（[`packages/image/tool-image-generation/src/index.ts`](../packages/image/tool-image-generation/src/index.ts)）
...
- `@deepseek-ai/dsh-image-generation` — 抽象 `ImageGenerationRuntime`（[`packages/image/image-generation/src/index.ts`](../packages/image/image-generation/src/index.ts)）
